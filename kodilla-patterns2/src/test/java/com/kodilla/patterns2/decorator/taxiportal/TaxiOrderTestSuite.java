...
public class TaxiOrderTestSuite {
    ...
    public void testTaxiNetworkGetCost() {
        ...
        //Then
        Assert.assertEquals(new BigDecimal(40.00),theCost);
    }
    ...
    public void testMyTaxiWithChildSeatGetCost() {
        ...
        BigDecimal theCost = theOrder.getCost();
        //Then
        Assert.assertEquals(new BigDecimal(37.00),theCost);
    }
    ...
    public void testUberWithTwoChildSeatGetCost() {
        ...
        BigDecimal theCost = theOrder.getCost();
        //Then
        Assert.assertEquals(new BigDecimal(29.00),theCost);
    }
    ...
    public void testVipTaxiWithChildSeatExpressGetCost() {
        ...
        BigDecimal theCost = theOrder.getCost();
        //Then
        Assert.assertEquals(new BigDecimal(57.00),theCost);
    }
    ...
    public void testVipTaxiWithChildSeatExpressGetDescription() {
        ...
        String description = theOrder.getDescription();
        //Then
        Assert.assertEquals("Drive a course by Taxi Network variant VIP express service + child seat", description);
    }
}
